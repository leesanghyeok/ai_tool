...
- `feedback-ai-logging`: AI/agent 출력 불만족 사례를 LLM Wiki `raw/feedback/` 아래에 구조화된 Markdown 로그로 남깁니다.
...
```text
Use $feedback-ai-logging to record AI output dissatisfaction as a feedback log.
