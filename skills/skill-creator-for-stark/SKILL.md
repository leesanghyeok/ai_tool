...
- declared case는 `validate-package`, `runner-regression`, `eval-contract-docs`, `create-skill-scenario`, `create-skill-scenario-llm-judge`, `modify-skill-scenario`, `modify-skill-scenario-llm-judge`, `migrate-skill-format-scenario-llm-judge`를 보존한다.
